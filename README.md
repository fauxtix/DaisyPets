...
For the web project screenshots, navigate to [Web Project](https://github.com/fauxtix/DaisyPets/tree/master/DaisyPets.Web.Blazor/) 'daisypets.web.blazor / screenhots'.
