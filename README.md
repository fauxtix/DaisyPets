...
Due to its simplicity, the SQLite database was chosen for data storage. For the database structure, please see https://github.com/fauxtix/DaisyPets/blob/master/MauiPetsApp/MauiPets/PetsDB.db.sql
