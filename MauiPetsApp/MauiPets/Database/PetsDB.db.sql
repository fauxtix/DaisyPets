...
CREATE TABLE IF NOT EXISTS "PetPhoto" (
	"Id"	INTEGER,
	"PetId"	INTEGER NOT NULL,
...
INSERT INTO "AppSettings" ("CultureName") VALUES ('en-GB');
INSERT INTO "AppSettings" ("CultureName") VALUES ('pt-PT');
INSERT INTO "AppointmentData" ("Id","Subject","Location","StartTime","EndTime","Description","IsAllDay","RecurrenceRule","RecurrenceException","RecurrenceId","IsReadonly","AppointmentType","PetId") VALUES (1,'Continente Online','Home','09/08/2023 15:30:00','09/08/2023 17:00:00','Compras da quinzena',0,'','',0,0,5,NULL);
...
INSERT INTO "Contacto" ("Id","Nome","Morada","Localidade","Movel","EMail","Notas","IdTipoContacto","Latitude","Longitude") VALUES (4,'Clínica Veterinária de Odivelas','Rua Guilherme Gomes Fernandes 21 rés do chão dto','Odivelas','219313237','','Horários de funcionamento em:

www.clinicaveterinariadeodivelas.pt
',1,NULL,NULL);
INSERT INTO "Contacto" ("Id","Nome","Morada","Localidade","Movel","EMail","Notas","IdTipoContacto","Latitude","Longitude") VALUES (5,'Clínica Veterinaria Absolut Pets','Praca de Portugal, 3 Loja esq ','Colinas do Cruzeiro - Odivelas','219325418','absolutpets@gmail.com','Horários de funcionamento em:

https://www.absolutpets.com/horario-e-contactos.html
',1,NULL,NULL);
INSERT INTO "Contacto" ("Id","Nome","Morada","Localidade","Movel","EMail","Notas","IdTipoContacto","Latitude","Longitude") VALUES (6,'Clínica Veterinária Dom Dinis','Rua Abel Manta 1','Odivelas','219338652','','https://www.clinicaveterinariadomdinis.pt/clinica-geral

',1,NULL,NULL);
INSERT INTO "Contacto" ("Id","Nome","Morada","Localidade","Movel","EMail","Notas","IdTipoContacto","Latitude","Longitude") VALUES (7,'União Zoófila',' R. Padre Carlos dos Santos','Alto das Furnas - Lisboa','0','uniaozoofila@gmail.com ','Horários de funcionamento em:

www.uniaozoofila.org
',2,NULL,NULL);
INSERT INTO "Contacto" ("Id","Nome","Morada","Localidade","Movel","EMail","Notas","IdTipoContacto","Latitude","Longitude") VALUES (8,'ANIMALIFE','Av. Praia da Victória - 15 - Cave','Lisboa','707309233','geral@animalife.pt','Horários de funcionamento em :

https://www.animalife.pt/pt/home
',2,NULL,NULL);
INSERT INTO "Contacto" ("Id","Nome","Morada","Localidade","Movel","EMail","Notas","IdTipoContacto","Latitude","Longitude") VALUES (9,'Associação Zoófila Portuguesa (AZP)','Av. Luís Bívar 85C','Lisboa','217970827','info@azp.pt','Serviços e horários de funcionamento em:

https://azp.pt/
',2,NULL,NULL);
INSERT INTO "Contacto" ("Id","Nome","Morada","Localidade","Movel","EMail","Notas","IdTipoContacto","Latitude","Longitude") VALUES (16,'A Casota dos bichos','Av 25 Abril 22 Loja B','Ramada - Odivelas','910318189','acasotadosbichos@hotmail.com','https://www.nicepage.com/website-templates

',1,NULL,NULL);
INSERT INTO "Contacto" ("Id","Nome","Morada","Localidade","Movel","EMail","Notas","IdTipoContacto","Latitude","Longitude") VALUES (17,'VetMonti - Drª Susana Barão Alves','R. Dr. Augusto Pereira Coutinho 4 - 2870 309 - Montijo','Montijo','918700387','vetmonti@gmail.com','Horários de funcionamento em:

Site: vetmonti-clinica-veterinaria.negocio.site',1,NULL,NULL);
...
INSERT INTO "Desparasitante" ("Id","IdPet","Tipo","Marca","DataAplicacao","DataProximaAplicacao") VALUES (21,17,'I','Purina Extra','01/06/2023','01/09/2023');
INSERT INTO "Desparasitante" ("Id","IdPet","Tipo","Marca","DataAplicacao","DataProximaAplicacao") VALUES (22,18,'I','Purina','10/08/2023','10/11/2023');
INSERT INTO "Desparasitante" ("Id","IdPet","Tipo","Marca","DataAplicacao","DataProximaAplicacao") VALUES (23,17,'E','Purina','02/09/2023','02/12/2023');
INSERT INTO "Documento" ("Id","Title","Description","DocumentPath","CreatedOn","PetId") VALUES (24,'Análises bioquímicas','Descrição que ajude a explicar o que o documento mostra','Shiva_Analises_BIOQUIMICAS.pdf','16/09/2023',18);
...
INSERT INTO "Peso" ("Id","De","A","Descricao") VALUES (4,46,100,'Muito grande');
INSERT INTO "Pet" ("Id","IdEspecie","IdRaca","DataNascimento","IdSituacao","Nome","Foto","Cor","IdPeso","IdTemperamento","Medicacao","IdTamanho","Genero","Chip","Chipado","DataChip","NumeroChip","Esterilizado","Padrinho","DoencaCronica","Observacoes") VALUES (17,1,11,'11/01/2017',1,'Olie','Olie.jpg','Preto e branco',16,1,'',2,'M','',1,'06/01/2021','7397879842',1,0,'','');
INSERT INTO "Pet" ("Id","IdEspecie","IdRaca","DataNascimento","IdSituacao","Nome","Foto","Cor","IdPeso","IdTemperamento","Medicacao","IdTamanho","Genero","Chip","Chipado","DataChip","NumeroChip","Esterilizado","Padrinho","DoencaCronica","Observacoes") VALUES (18,1,9,'07/05/2018',1,'Che','Che.jpg','Castanho',10,1,'Nada conhecido',1,'M','',1,'14/07/2021','2535453541',1,0,'Desconhecida','Observações');
...
INSERT INTO "Tamanho" ("Id","Descricao") VALUES (4,'Muito Grande');
